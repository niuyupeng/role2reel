...
RELEASE_FILES = (
    ...
    "assets/templates/clipboard-prompt.yaml",
    ...
    "assets/templates/episode-eval.json",
    ...
    "assets/templates/shot-readiness-review.yaml",
    "assets/templates/source-truth-ledger.yaml",
    ...
    "assets/templates/timing-plan.yaml",
    "assets/templates/video-task.yaml",
    "assets/templates/video-prompt.md",
    "assets/templates/copy-paste-shot-block.txt",
    ...
    "references/copy-paste-prompt-contract.md",
    "references/dynamic-shot-timing.md",
    "references/end-to-end-example.md",
    "references/episode-calibration.md",
    ...
    "references/atomic-shot-gate.md",
    "references/multi-role-shot-review.md",
    "references/physical-sound-continuity.md",
    "references/post-composite-text.md",
    "references/source-truth-gate.md",
    ...
    "scripts/audit_clipboard_prompts.py",
    ...
    "scripts/audit_shot_readiness.py",
    "scripts/audit_video_task.py",
    "scripts/init_project.py",
    "scripts/episode_eval.py",
    ...
    "tests/test_clipboard_prompt_audit.py",
    ...
    "tests/test_story_roundtrip_package.py",
    "tests/test_episode_eval.py",
    "tests/test_dialogue_roundtrip.py",
    "tests/test_storyboard_v2_audit.py",
    "tests/test_shot_readiness_audit.py",
